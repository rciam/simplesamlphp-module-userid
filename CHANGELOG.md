...
- Issue with `OpaqueSmartID` filter searching for authenticating authority when `add_authority` is not enabled
...
- `UserID` state attribute should be stored as a string instead of an array
